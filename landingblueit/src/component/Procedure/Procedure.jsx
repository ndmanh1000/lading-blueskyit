        ...
        <div className="border-b">
          ...
          {activeSection === 1 && (
            <div className="p-4 text-gray-600 bg-[#e4f7ff]">
              <p>
                (Tìm hiểu nhu cầu của khách hàng, phân tích yêu cầu và xác định
                giải pháp phù hợp để đảm bảo sản phẩm cuối cùng đáp ứng mục tiêu
                kinh doanh.)
              </p>
            </div>
          )}
          ...
          {activeSection === 2 && (
            <div className="p-4 text-gray-600 bg-[#e4f7ff]">
              <p>
                ...
                đã phân tích, tạo ra sản phẩm có tính thẩm mỹ và hiệu suất cao.
              </p>
            </div>
          )}
        </div>
          ...
          {activeSection === 3 && (
            <div className="p-4 text-gray-600 bg-[#e4f7ff]">
              <p>
                ...
                bảo hệ thống luôn hoạt động ổn định, cập nhật và tối ưu hóa khi
                cần.
              </p>
            </div>
          )}
          ...
          {activeSection === 4 && (
            <div className="p-4 text-gray-600 bg-[#e4f7ff]">
              <p>
                ...
                quá trình triển khai diễn ra suôn sẻ và không gây gián đoạn cho
                hệ thống.
              </p>
            </div>
          )}
        ...
        <div className="border-b">
          ...
          {activeSection === 5 && (
            <div className="p-4 text-gray-600 bg-[#e4f7ff]">
              <p>
                {" "}
                Kiểm thử toàn diện sản phẩm nhằm phát hiện lỗi, tối ưu hiệu suất
                và đảm bảo chất lượng trước khi chính thức đưa vào sử dụng.
              </p>
            </div>
          )}
        </div>
